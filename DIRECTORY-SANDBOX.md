...
The CRUD API and admin screen will be delivered in increment 2. This data is synthetic and must never be represented as the AIFE/DGFiP production directory.
